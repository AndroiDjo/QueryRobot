...
public class Const {
    //голосовые команды
    public static final String ROBO_NAME = "квэри";
    public static final String LOOK = "следи за лицом";
    public static final String ATTENTION = "обрати внимание";
    public static final String CAM_ON = "включи камеру";
